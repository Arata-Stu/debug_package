...
public:
        ...
        : Node("control_command_publisher")
    {
        ...
        // Float32MultiArrayのパブリッシャー
        control_command_publisher_ = this->create_publisher<std_msgs::msg::Float32MultiArray>(
...
private:
    ...
    {
        auto command_msg = std_msgs::msg::Float32MultiArray();
        command_msg.data.push_back(handle_position_);
        command_msg.data.push_back(throttle_position_);
        command_msg.data.push_back(brake_position_);
    ...
    rclcpp::Publisher<std_msgs::msg::Float32MultiArray>::SharedPtr control_command_publisher_;
